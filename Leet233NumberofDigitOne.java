 ...
 */
public class Leet233NumberofDigitOne {
	/**
	 ...
	 * long. So (a / 10 + 1) * 100 times, the hundreds-digit is 1.
	 * 
	 ...
	 * However, since the thousands-digit is a 1, the very last streak isn't 1000 numbers but only
	 * 593 numbers, for the suffixes "000" to "592". So (a / 10 * 1000) + (b + 1) times, the
	 * thousands-digit is 1.
	 * 
	 * The case distincton between the current digit/position being 0, 1 and >=2 can easily be done
	 * in one expression. With (a + 8) / 10 you get the number of full streaks, and a % 10 == 1
